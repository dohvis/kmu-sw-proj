...
class Calculator(QWidget):
    def __init__(self, parent=None):
        ...
        # Digit Buttons
        self.digitButtons = [Button(str(x), self.buttonClicked) for x in range(0, 10)]
        ...
        for i, button in enumerate(self.digitButtons[1:]):
            i += 1
            numLayout.addWidget(button, 2 - (i - 1) // 3, (i + 2) % 3)
